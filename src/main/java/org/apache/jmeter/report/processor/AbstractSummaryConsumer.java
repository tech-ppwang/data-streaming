...
public abstract class AbstractSummaryConsumer<TData> extends
    ...
    protected class SummaryInfo {
         ...
         *
         * @param isController true, if these information implies only controller
     ...
     * Defines whether the result contains an overall item.
     *
     * @param hasOverallResult true, if the result contains an overall item; false otherwise
     */
     ...
     *
     * @param supportsControllersDiscrimination indicates whether this summary can discriminate controller
     *                                          samples
     */
